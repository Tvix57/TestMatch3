  ...
  return {
    ...
    execute: function () {
      ...
      _export("AudioManagerComponent", AudioManagerComponent = (_dec4 = ccclass('AudioManagerComponent'), _dec5 = property(AudioSource), _dec6 = property(Node), _dec7 = property({
        ...
        SetLoop(name, loop) {
          let item = this.soundLayer.getComponentsInChildren(AudioSource).find(cmp => {
            var _cmp$clip3;
        ...
        removeSound(item) {
          const cmp = this.soundLayer.getComponentsInChildren(AudioSource).find(cmp => {
            var _cmp$clip5;
