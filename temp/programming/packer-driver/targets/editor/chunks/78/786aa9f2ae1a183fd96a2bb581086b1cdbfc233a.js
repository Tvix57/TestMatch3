System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "39c90+ZlgJBOpJzpuOo+xZ8", "TransferComponent", undefined);
      ...
      _export("TransferComponent", TransferComponent = (_dec = ccclass('TransferComponent'), _dec2 = requireComponent(Button), _dec3 = property({
        ...
        start() {
          this.node.on(Button.EventType.CLICK, () => {
            let transfer = (_crd && AppRoot === void 0 ? (_reportPossibleCrUseOfAppRoot({
              error: Error()
...
//# sourceMappingURL=786aa9f2ae1a183fd96a2bb581086b1cdbfc233a.js.map