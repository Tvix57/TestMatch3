      ...
      _export("ScenePoolManagerComponent", ScenePoolManagerComponent = (_dec = ccclass("ScenePoolManagerComponent"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property({
        ...
        async Preload() {
          for (const [name, entry] of this._locationMap) {
            this.CreateScene(entry.scenePath).then(value => {
              value.active = false;
              ...
              this._dispatcher.Post(arg => arg.OnLoadedScene == null ? void 0 : arg.OnLoadedScene(this.loadedIndex, this._locationMap.size));
